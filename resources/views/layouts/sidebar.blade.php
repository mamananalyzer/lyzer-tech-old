...
<!-- <body> -->
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="index.html">E-Official
                    <!-- <img src="./assets/mazer/compiled/svg/logo.svg" alt="Logo" srcset=""> -->
                </a>
            </div>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li
                class="sidebar-item">
                <a href="dashboard" class='sidebar-link' onclick="activateSidebarItem(this)">
            ...
            <li
                class="sidebar-item">
                <a href="treasure" class='sidebar-link' onclick="activateSidebarItem(this)">
        ...
        <script>
            function activateSidebarItem(clickedElement) {
                ...
                var clickedItem = clickedElement.closest('.sidebar-item');
